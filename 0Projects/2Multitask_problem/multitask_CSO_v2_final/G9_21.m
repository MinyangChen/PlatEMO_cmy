...
% Output 'g' denotes all the constraint values of the solution
    ...
    v1 = 2*x(1)^2;
    v2 = x(2)^2;
    g(1) = v1+3*v2^2+x(3)+4*x(4)^2+5*x(5)-127 + 2;
    g(2) = 7*x(1)+3*x(2)+10*x(3)^2+x(4)-x(5)-282 - 2;
    g(3) = 23*x(1)+v2+6*x(6)^2-8*x(7)-196 + 2;
    g(4) = 2*v1+v2-3*x(1)*x(2)+2*x(3)^2+5*x(6)-11*x(7) - 2;
end
