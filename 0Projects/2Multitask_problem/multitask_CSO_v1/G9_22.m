...
% Output 'g' denotes all the constraint values of the solution
    ...
    (x(8)-8)^2+5*(x(9)-10)^2+x(10)^4+3*(x(11)-9)^2+...      % new added, -2
    8*x(12)^6+5*x(13)^2+x(14)^4-2*x(13)*x(14)*x(15)-8*x(13)*x(15)-6*x(14)*x(15);

    v1 = 2*x(1)^2;
    v2 = x(2)^2;
    g(1) = v1+3*v2^2+x(3)+4*x(4)^2+5*x(5)-127 + 3*x(8) + 3*x(9) - 2; % add 3x_8-15
    g(2) = 7*x(1)+3*x(2)+10*x(3)^2+x(4)-x(5)-282 + 3*x(10) + 3*x(11) + 2;
    g(3) = 23*x(1)+v2+6*x(6)^2-8*x(7)-196 + 3*x(12) + 3*x(13) - 2;
    g(4) = 2*v1+v2-3*x(1)*x(2)+2*x(3)^2+5*x(6)-11*x(7) + 3*x(14) + 3*x(15) + 2;
end
